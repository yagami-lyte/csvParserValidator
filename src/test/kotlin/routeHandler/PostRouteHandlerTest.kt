...
internal class PostRouteHandlerTest {
    ...
    fun shouldBeAbleToGetResponseForCsvPOSTRequest() {
        ...
        val expectedResponse = """{"Duplicates" : [],"Length" : [{"1":"Incorrect length of Country Name. Please change its length to 4 in the CSV."},{"2":"Incorrect length of Country Name. Please change its length to 4 in the CSV."}],"Type" : [],"Value" : [{"1":"Incorrect Value of Country Name. Please select value from [Export,Country Name, Y,, N,USA, ] in the CSV."},{"2":"Incorrect Value of Country Name. Please select value from [Export,Country Name, Y,, N,USA, ] in the CSV."}],"Dependency" : [],"Null" : [],"PrePendingZero" : []}"""
